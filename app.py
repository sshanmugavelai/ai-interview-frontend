...
def show_analytics():
    ...
    try:
        ...
        if analytics_response.status_code == 200:
            ...
            with col1:
                st.metric("Total Hours Studied", f"{analytics['total_hours_studied']:.1f}h")
            with col2:
            ...
            with col1:
                ...
                if analytics['confidence_trend']:
                    ...
                    fig = px.line(df, x='day', y='confidence', 
            ...
            with col2:
                ...
                if analytics['topics_covered']:
                    topic_counts = pd.Series(analytics['topics_covered']).value_counts().head(10)
                    fig = px.bar(x=topic_counts.values, y=topic_counts.index,
